        ...
        try {
            ...
            String sql = """
                            SELECT O.OrderID,
                                    ...
                                    WHERE O.UsersID = ?
                                    GROUP BY O.OrderID, A.ReceiverName, O.OrderDate, O.Status
            ...
            while (rs.next()) {
                String orderId = "#" + rs.getInt("OrderID");
                ...
                item.setOrderData(orderId, receiver, date, status, price);
                ...
                ListOrder.add(item);
                ListOrder.add(Box.createVerticalStrut(0));
            }
        }
        catch (Exception e) {
                e.printStackTrace();
