...
public class chitiet1 extends javax.swing.JFrame {
    ...
    private void initComponents() {
        ...
        for (String imgName : images) {
            ...
            try {
                ImageIcon icon = new ImageIcon(getClass().getResource("/asset/picture/product/" + imgName));
        ...
        try {
            ImageIcon icon = new ImageIcon(getClass().getResource("/asset/picture/product/giay2.jpg"));
